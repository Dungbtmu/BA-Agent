...
- `.claude/skills/urd/references/document-integrity-check.md` — 5 kiểm tra toàn vẹn: section completeness, traceability chain, naming consistency, version hygiene, placeholder detection
