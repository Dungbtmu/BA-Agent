...
- `.claude/skills/process-log.md` — cách đọc artifacts, trích xuất quyết định, xây dựng Handoff Note
- `.claude/skills/assumption-risk-analysis.md` — phân loại assumption Confirmed/Unverified/Risky
