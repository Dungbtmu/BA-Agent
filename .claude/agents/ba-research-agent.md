...
- `.claude/skills/clarification/references/domain-research.md` — cách search hiệu quả, đánh giá nguồn, tổng hợp Domain Brief chuẩn
...
File **Domain Brief** lưu tại: `.claude/output/[tên_dự_án]/research/domain-brief.md`
