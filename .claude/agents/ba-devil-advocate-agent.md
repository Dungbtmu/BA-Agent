...
- `.claude/skills/solution/references/solution-critique.md` — framework phản biện 4 lens: User, Business, Feasibility, Risk
- `.claude/skills/solution/references/assumption-risk-analysis.md` — xác định assumption ẩn và đánh giá rủi ro
