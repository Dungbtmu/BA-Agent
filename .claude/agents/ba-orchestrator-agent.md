...
```
→ Đọc skill: .claude/skills/traceability-map.md
...
```
→ Đọc skill: .claude/skills/change-handler.md
...
```
→ Đọc skill: .claude/skills/impact-analysis.md
...
```
→ Đọc skill: .claude/skills/artifact-patch.md
