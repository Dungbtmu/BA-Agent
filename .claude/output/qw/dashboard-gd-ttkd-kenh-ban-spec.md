...
> Nguồn đối chiếu: giao diện mẫu `dashboard_gd_ttkd (16).html` + bảng data inventory + bảng đặc tả tổng của team (STT 17–20)
> Phạm vi bảng này: chỉ phần **Hiệu quả kênh bán** (STT 17–20 trong bảng tổng)
...
- [ ] OQ-3: Có cần hiển thị 2 chỉ số nền "Tổng điểm bán" / "Tổng LLBH" thành card độc lập không?
...
- [ ] OQ-5: Combo Chart khi drill xuống 1 BĐX (STT 18–19) — có phải hành vi Ban mong muốn, hay chỉ hiển thị Bar Chart thuần theo doanh thu như Top/Bottom?
