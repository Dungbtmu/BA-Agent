...
| REQ-CVM-014 | Duyệt / Từ chối campaign bởi Admin — phê duyệt chuyển Active, từ chối chuyển Draft kèm lý do bắt buộc; **(v4.15) disable nút [Phê duyệt] nếu độ ưu tiên trùng campaign Active khác** — Admin không tự sửa priority tại màn Duyệt; [Từ chối] vẫn là action tự quyết định như bình thường (không bị ép buộc), chỉ là con đường duy nhất để QTV sửa lại priority (thống nhất với REQ-CVM-020) | UC-CAM-05 | Screen Admin | URD-III-UC-CAM-05, URD-IV-Screen-Admin | | v4.15: lỗ hổng thứ 4 của chuỗi chặn trùng độ ưu tiên — trước đó chỉ chặn ở Campaign List/Builder/Priority Matrix, chưa chặn đúng thời điểm Pending → Active |
