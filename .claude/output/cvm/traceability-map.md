...
| REQ-CVM-020 | Độ ưu tiên campaign — mặc định = max priority của campaign Active + 1; **(v4.14) không cho phép 2 campaign Active cùng độ ưu tiên — thống nhất chặn trùng tại cả 3 nơi sửa**: Campaign List (chặn ngay khi nhập, trước confirm dialog), Campaign Builder (Lưu Nháp vẫn cho trùng, chặn tại Gửi duyệt), Priority Matrix (chặn cứng, disable nút Lưu — hành vi có từ trước); tie-break theo created_at giữ lại chỉ làm phòng vệ race condition; **sửa priority trực tiếp trên Campaign List (v4) — bắt buộc chuyển về Chờ duyệt, khác Priority Matrix (Admin tự sắp xếp không cần duyệt lại)**; **range 1–9999 + thông báo lỗi cụ thể tại Campaign List (v4.11)**, đồng bộ ngưỡng với Campaign Builder | UC-CAM-01, UC-CAM-02, UC-PRIORITY-01 | Screen 2, Screen 3, Screen Settings | URD-II.6.8, URD-III-UC-CAM-01, URD-III-UC-CAM-02, URD-III-UC-PRIORITY-01, URD-IV-Screen2 (STT 7), URD-IV-Screen3 (Section 1 STT 5), URD-IV-Screen-Settings (Tab 3) | | v4: UC-CAM-01 bổ sung vào cột UC vì đã có luồng sửa priority tại Campaign List; v4.14: thống nhất quy tắc chặn trùng, sửa mâu thuẫn Builder ghi "cho phép trùng" trong khi Priority Matrix đã chặn cứng |
