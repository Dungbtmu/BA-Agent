# Lovable Prompt — CVM System v8
> Cập nhật từ v7: Dashboard 8 KPI + System Health; Campaign List bỏ cột Logic, thêm Mã campaign; Campaign Builder 1 cột bỏ Smart Panel; S2 Trigger mặc định trống; S3 Audience dropdown; S4 thêm Thời gian gửi + Audience Variant đầy đủ; S5 bỏ pipeline UI, chỉ giữ đặt lịch per kênh; S6 bỏ Frequency Cap; Template 4B tab-per-channel card layout; Trigger Management nhóm collapsible; Report 6 tab; Campaign Builder 2-column layout (S1/S2/S4/S6 trái scroll, S3/S5/Summary phải sticky); S4 Message Matrix preview luôn hiển thị 2 cột inline, không cần click
