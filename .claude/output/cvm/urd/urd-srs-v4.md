...
*Phiên bản: V4.8 | Ngày: 22/08/2026 | Tác giả: Jun (BA)*
*Đợt cập nhật gần nhất: Preview Section 4 (Campaign Builder) đổi sang hiển thị đồng thời toàn bộ Audience Variant dạng N mockup card xếp dọc, không còn phải click từng tab biến thể mới xem được.*
