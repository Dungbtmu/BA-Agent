...
*Phiên bản: V4.13 | Ngày: 22/08/2026 | Tác giả: Jun (BA)*
*Đợt cập nhật gần nhất: UC-CAM-07 bổ sung nhánh "Mở khóa param/điều kiện lọc" — campaign Chờ duyệt bị Khóa param tự Paused, khi Admin Mở khóa lại thì [Bật] phải trả về đúng trạng thái gốc (Chờ duyệt), không tự động chạy thẳng Active.*
