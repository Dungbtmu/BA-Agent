...
*Phiên bản: V4.10 | Ngày: 22/08/2026 | Tác giả: Jun (BA)*
*Đợt cập nhật gần nhất: bổ sung ghi chú nối rõ giữa "N × M bản ghi" (UC-BL-01/02, lưu trữ) và "gộp 1 dòng theo Số điện thoại" (UC-BL-00/Screen 6A, hiển thị) — tránh hiểu nhầm khi đọc riêng lẻ từng UC.*
