...
- **Khoảng cách tối thiểu giữa các lần nhắc** (đơn vị giờ, ví dụ: 24)

**Cơ chế hoạt động:**
1. Campaign gửi tin lần đầu thành công (Delivered) cho KH theo trigger đã khớp
2. Hệ thống đặt lịch kiểm tra lại sau đúng khoảng cách đã cấu hình (ví dụ: sau 24 giờ)
...
| 8 | Toggle "Cho phép nhắc lại" | Toggle | – | Tắt | Xem II.6.10; Bật → hiện 2 ô: "Số lần nhắc lại tối đa" (số nguyên dương, placeholder "VD: 2") và "Khoảng cách tối thiểu giữa các lần (giờ)" (số nguyên dương, placeholder "VD: 24"); tắt → ẩn 2 ô, hệ thống chỉ gửi 1 lần theo trigger, không tự nhắc lại; **Validate**: khi Bật, cả 2 ô bắt buộc nhập, số nguyên dương từ 1 đến 9999 — thông báo lỗi "Vui lòng nhập đầy đủ số lần và khoảng cách nhắc lại"; **Ghi chú**: "Hệ thống chỉ nhắc lại nếu khách hàng vẫn thoả điều kiện trigger tại thời điểm kiểm tra — không nhắc nếu KH đã tự xử lý xong" |
...
*Phiên bản: V4.1 | Ngày: 21/08/2026 | Tác giả: Jun (BA)*
