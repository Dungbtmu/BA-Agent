...
*Phiên bản: V4.11 | Ngày: 22/08/2026 | Tác giả: Jun (BA)*
*Đợt cập nhật gần nhất: rà soát bổ sung validate cho các field đã update V4.0-V4.10 — sửa mâu thuẫn Campaign/Kênh bắt buộc tại Modal 6B (Blacklist), bổ sung range + thông báo lỗi cho cột Ưu tiên tại Campaign List, làm rõ giới hạn 0–100 cho đơn vị % tại UC-CAM-02.*
