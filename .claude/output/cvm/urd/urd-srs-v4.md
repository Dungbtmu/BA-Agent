...
*Phiên bản: V4.15 | Ngày: 07/09/2026 | Tác giả: Jun (BA)*
*Đợt cập nhật gần nhất: bổ sung chặn trùng độ ưu tiên tại UC-CAM-05 (Phê duyệt) — lỗ hổng thứ 4 chưa được V4.14 bao phủ; bấm [Duyệt] mở dialog, trùng thì dialog đổi nội dung sang cảnh báo (chỉ [Đóng]); Admin không tự sửa priority tại màn Duyệt; [Từ chối] vẫn là action tự quyết định như bình thường, không bị ép buộc.*
