...
*Phiên bản: V4.4 | Ngày: 21/08/2026 | Tác giả: Jun (BA)*
*Đợt cập nhật gần nhất: cho phép Xóa template kể cả khi đang dùng; Trigger trên Template đổi thành single-select bắt buộc, tham số động lấy đúng theo trigger đã chọn.*
