...
| C3e | — Cột Hành động | Icon button | – | – | Icon [Xóa] hiện khi hover dòng; nhấn → xóa ngay, toast "Đã xóa điều kiện lọc" |
