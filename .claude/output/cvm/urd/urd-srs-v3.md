...
| 29/06/2026 | Jun | UC-CAM-05 (Hoạt động, Quy tắc nghiệp vụ); II.6.4 | U | Xóa exception Paused trong UC-CAM-05 (dead code — không thể xảy ra vì Paused chỉ đến từ Active, không từ Pending); bổ sung rule background job tự động chuyển → Ended cho tất cả trạng thái (Active/Pending/Paused) khi qua endDate; cập nhật exception Ended trong UC-CAM-05 và bảng II.6.4. | V3.9 |
