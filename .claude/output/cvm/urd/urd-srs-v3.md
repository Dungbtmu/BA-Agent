...
| 6 | Section 3 — Audience | Read-only | – | – | Danh sách phân khúc đã chọn (tag), logic phân khúc, số KH ước tính. **Điều kiện lọc**: hiển thị dạng danh sách dọc, mỗi dòng gắn nhãn tên phân khúc ở đầu để phân biệt điều kiện đó thuộc phân khúc nào — ví dụ "**[ARPU cao]** Loại thiết bị = Android • Gói cước = D200", "**[Gen Z User]** Trạng thái SIM ≠ Tạm khóa • Số ngày không giao dịch > 14"; các điều kiện trong cùng nhãn phân khúc nối bằng dấu "•" (quan hệ AND, đúng như đã cấu hình ở Campaign Builder); phân khúc không có điều kiện lọc riêng thì không xuất hiện dòng nào cho phân khúc đó (không hiển thị nhãn rỗng) |
...
*Phiên bản: V3.24 | Ngày: 14/07/2026 | Tác giả: Jun (BA)*
