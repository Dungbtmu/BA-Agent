...
- `.claude/skills/` — kỹ năng hỗ trợ research domain, phân tích, làm rõ, viết URD/SRS, sơ đồ URD/SRS, wireframe iteration và React prototype.
...
- `ui-react-agent` phải đọc `react-ui-generation`.
...
- `ba-qa-agent` khi review URD/SRS phải đọc `urd-review-checklist` nếu file này tồn tại.
