...
| Vai trò | File hướng dẫn | Kỹ năng liên quan (Skills) | Dùng khi nào |
|---|---|---|---|
| `urd-srs-agent` | [urd-srs-agent.md](file:///Users/buidung/Documents/workspace/aeh/eduecosystem/ba-agent/.claude/agents/urd-srs-agent.md) | [urd-srs-structure.md](file:///Users/buidung/Documents/workspace/aeh/eduecosystem/ba-agent/.claude/skills/urd/urd-srs-structure.md) cùng với các kỹ năng chi tiết theo phần ([workflow-diagram](file:///Users/buidung/Documents/workspace/aeh/eduecosystem/ba-agent/.claude/skills/urd/urd-workflow-diagram.md), [function-tree](file:///Users/buidung/Documents/workspace/aeh/eduecosystem/ba-agent/.claude/skills/urd/urd-function-tree.md), [permission-matrix](file:///Users/buidung/Documents/workspace/aeh/eduecosystem/ba-agent/.claude/skills/urd/urd-permission-matrix.md), [sequence-diagram](file:///Users/buidung/Documents/workspace/aeh/eduecosystem/ba-agent/.claude/skills/urd/urd-sequence-diagram.md), [use-case](file:///Users/buidung/Documents/workspace/aeh/eduecosystem/ba-agent/.claude/skills/urd/urd-use-case.md), [screen-spec](file:///Users/buidung/Documents/workspace/aeh/eduecosystem/ba-agent/.claude/skills/urd/urd-screen-spec.md)) | Viết tài liệu URD/SRS hoàn chỉnh, sẵn sàng cho đội ngũ Dev/Test — đây là sản phẩm đầu ra chính. |
| `ba-qa-agent` | [ba-qa-agent.md](file:///Users/buidung/Documents/workspace/aeh/eduecosystem/ba-agent/.claude/agents/ba-qa-agent.md) | [urd-review-checklist.md](file:///Users/buidung/Documents/workspace/aeh/eduecosystem/ba-agent/.claude/skills/urd/urd-review-checklist.md), [assumption-risk-analysis.md](file:///Users/buidung/Documents/workspace/aeh/eduecosystem/ba-agent/.claude/skills/solution/assumption-risk-analysis.md), [requirement-clarification.md](file:///Users/buidung/Documents/workspace/aeh/eduecosystem/ba-agent/.claude/skills/clarification/requirement-clarification.md) | Đánh giá chất lượng tài liệu — phát hiện các lỗ hổng logic, trường hợp bị thiếu, xung đột, rủi ro. Tự động chạy sau khi `urd-srs-agent` hoàn thành. |
...
| `ba-process-summary-agent` | [ba-process-summary-agent.md](file:///Users/buidung/Documents/workspace/aeh/eduecosystem/ba-agent/.claude/agents/ba-process-summary-agent.md) | [process-log.md](file:///Users/buidung/Documents/workspace/aeh/eduecosystem/ba-agent/.claude/skills/shared/process-log.md), [assumption-risk-analysis.md](file:///Users/buidung/Documents/workspace/aeh/eduecosystem/ba-agent/.claude/skills/solution/assumption-risk-analysis.md) | Tổng kết toàn bộ BA session — tạo Decision Log, Assumption Register và Handoff Note cho Dev/Tester. |

### Orchestration & Sync

| Vai trò | File hướng dẫn | Kỹ năng liên quan (Skills) | Dùng khi nào |
|---|---|---|---|
| `ba-orchestrator-agent` | [ba-orchestrator-agent.md](file:///Users/buidung/Documents/workspace/aeh/eduecosystem/ba-agent/.claude/agents/ba-orchestrator-agent.md) | [traceability-map.md](file:///Users/buidung/Documents/workspace/aeh/eduecosystem/ba-agent/.claude/skills/sync/traceability-map.md), [impact-analysis.md](file:///Users/buidung/Documents/workspace/aeh/eduecosystem/ba-agent/.claude/skills/sync/impact-analysis.md), [change-handler.md](file:///Users/buidung/Documents/workspace/aeh/eduecosystem/ba-agent/.claude/skills/sync/change-handler.md), [artifact-patch.md](file:///Users/buidung/Documents/workspace/aeh/eduecosystem/ba-agent/.claude/skills/sync/artifact-patch.md) | Điều phối toàn bộ BA pipeline (GENERATE) hoặc đồng bộ artifact khi requirement thay đổi (SYNC). |
...
Phase 1 — Làm rõ & Giải pháp
  ...
  [1] ba-clarification-agent   (nếu có Domain Brief → chạy domain-gap-analysis trước → hỏi clarify dựa trên gap)
   ↓
  [2] ba-solution-agent
   ↓
...
- Sau khi Write doc, chạy [resolve-oqs.md](file:///Users/buidung/Documents/workspace/aeh/eduecosystem/ba-agent/.claude/skills/shared/resolve-oqs.md) để collect + track Open Questions trước khi suggest bước tiếp theo.
